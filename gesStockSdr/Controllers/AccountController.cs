...
namespace gesStockSdr.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult modifierUser(String iduser)
        {
            ...
            ModifUserViewModel us = new ModifUserViewModel();
            us.Id = user.Id;
            us.UserName = user.UserName;
            us.role = user.role;
            us.password = user.PasswordHash;
            ViewBag.role = new SelectList(new[] { "admin", "normal" });
            return View(us);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult modifierUser(ModifUserViewModel profile)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    return RedirectToLocal("~/Categories/Index");
        ...
        { ViewBag.role = new SelectList(new[] { "admin", "normal" });
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.UserName, role= model.role, Email ="email@gmaul.com" };
